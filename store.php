...
<body>
  ...
  <div class="head">
    ...
    <div class="nav">
      ...
      <div class="but item-active"><a href="store"><u>Sto</u>re</a></div>
  ...
  <div class="content-wrapper">
    <div class="content">
      <div class="coming-soon">
        <h1 class="item-active">COMING SOON!</h1>
        <p>Stay tuned and check back to see when we have our online store up and running!</p>
      </div>
    </div>
  </div>
  <div class="foot">
