...
<body>
  ...
  <div class="modal" name="discdrive_modal">
    <div class="modal-content animate-top">
      ...
      <p>If your Xbox One failes to pull in a disc, doesn't spin properly, or doesnt read games, it can be one of many issues with your disc drive. If you have any of these issues we will be able to get you back up and running so you can play your favorite games once again!</p>
    </div>
  </div>
    ...
    <div class="updates">
      <div class="updates-content">
        <div class="product-title">
          <div class="prodtext">
            <h2 class="item-active"><u>Xbox One Rep</u>air</h2>
            ...
            <form class="contact-form" action="../includes/send.mail.inc.php" method="post">
              ...
              <div class="repair_opt">
                <label class="container"> Hard Drive Repair - $114.99
                  <input type="checkbox" name="repair_type[]" value="XboxOne_hdd_repair" data-id="0">
              ...
              <div class="repair_opt">
                <label class="container"> HDMI Repair - $89.99
                  <input type="checkbox" name="repair_type[]" value="XboxOne_hdmi_repair" data-id="1">
                  <span class="checkmark"></span>
                </label><br></br>
              ...
              <div class="repair_opt">
                <label class="container"> Overheating Repair - $99.99
                  <input type="checkbox" name="repair_type[]" value="XboxOne_overheat_repair" data-id="2">
                  <span class="checkmark"></span>
                </label><br></br>
              ...
              <div class="repair_opt">
                <label class="container"> Disc Drive Repair - $109.99
                  <input type="checkbox" name="repair_type[]" value="XboxOne_discdrive_repair" data-id="3">
                  <span class="checkmark"></span>
                </label><br></br>
          ...
          <div class="prodimg">
            <img src="images/xboxOneBig.png" alt="">
          </div>
        </div>
      </div>
    </div>
