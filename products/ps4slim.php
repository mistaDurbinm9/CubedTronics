...
<body>
  ...
  <div class="modal" name="overheat_modal">
    <div class="modal-content animate-top">
      ...
      <p>If your PS4 Slim tends to feel uncomfortably hot to the touch, or your fan spins abnormally loud, it is most likely an overheating issue. We clean out all dust and use high quality replacement thermal compound to restore your console's cooling system. If a fan replacement is needed, we can do that as well.</p>
    </div>
  </div>
  ...
  <div class="modal" name="discdrive_modal">
    <div class="modal-content animate-top">
      ...
      <p>If your PS4 Slim failes to pull in a disc, doesn't spin properly, or doesnt read games, it can be one of many issues with your disc drive. If you have any of these issues we will be able to get you back up and running so you can play your favorite games once again!</p>
    </div>
  </div>
    ...
    <div class="updates">
      <div class="updates-content">
        <div class="product-title">
          <div class="prodtext">
            <h2 class="item-active"><u>PS4 Slim Rep</u>air</h2>
          ...
          <div class="prodimg">
            <img src="images/ps4SlimBig.png" alt="">
          </div>
        </div>
      </div>
    </div>
