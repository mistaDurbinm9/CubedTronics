...
<body>
  ...
  <div class="modal" name="overheat_modal">
    <div class="modal-content animate-top">
      ...
      <p>If your Xbox One X tends to feel uncomfortably hot to the touch, or your fan spins abnormally loud, it is most likely an overheating issue. We clean out all dust and use high quality replacement thermal compound to restore your console's cooling system. If a fan replacement is needed, we can do that as well.</p>
    </div>
  </div>
  ...
  <div class="modal" name="discdrive_modal">
    <div class="modal-content animate-top">
      ...
      <p>If your Xbox One X failes to pull in a disc, doesn't spin properly, or doesnt read games, it can be one of many issues with your disc drive. If you have any of these issues we will be able to get you back up and running so you can play your favorite games once again!</p>
    </div>
  </div>
    ...
    <div class="updates">
      <div class="updates-content">
        <div class="product-title">
          <div class="prodtext">
            <h2 class="item-active"><u>Xbox One X Rep</u>air</h2>
            ...
            <form class="contact-form" action="../includes/send.mail.inc.php" method="post">
              ...
              <div class="repair_opt">
                <label class="container"> Hard Drive Repair - $114.99
                  <input type="checkbox" name="repair_type[]" value="XboxOneX_hdd_repair" data-id="0">
              ...
              <div class="repair_opt">
                <label class="container"> HDMI Repair - $89.99
                  <input type="checkbox" name="repair_type[]" value="XboxOneX_hdmi_repair" data-id="1">
                  <span class="checkmark"></span>
                </label><br></br>
              ...
              <div class="repair_opt">
                <label class="container"> Overheating Repair - $99.99
                  <input type="checkbox" name="repair_type[]" value="XboxOneX_overheat_repair" data-id="2">
                  <span class="checkmark"></span>
                </label><br></br>
              ...
              <div class="repair_opt">
                <label class="container"> Disc Drive Repair - $109.99
                  <input type="checkbox" name="repair_type[]" value="XboxOneX_discdrive_repair" data-id="3">
                  <span class="checkmark"></span>
                </label><br></br>
          ...
          <div class="prodimg">
            <img src="images/xboxOneXBig.png" alt="">
          </div>
        </div>
      </div>
    </div>
