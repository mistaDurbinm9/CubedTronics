            ...
            <form class="contact-form" action="../includes/send.mail.inc.php" method="post">
              ...
              <div class="repair_opt">
                <label class="container"> HDD Repair - $99.99
                  <input type="checkbox" name="repair_type[]" value="ps4_hdd_repair" data-id="0">
              ...
              <div class="repair_opt">
                <label class="container"> HDMI Repair - $99.99
                  <input type="checkbox" name="repair_type[]" value="ps_hdmi_repair" data-id="1">
                  <span class="checkmark"></span>
                </label><br></br>
              ...
              <div class="repair_opt">
                <label class="container"> Overheating Repair - $99.99
                  <input type="checkbox" name="repair_type[]" value="ps4_overheat_repair" data-id="2">
                  <span class="checkmark"></span>
                </label><br></br>
